...
<div class="card">
  ...
  <p class="hint">
    این ویدیوها به‌جای اسلایدر تصویری، به‌صورت یک <strong>اسلایدر تمام‌عرض</strong> در بالای صفحه‌ی فرود (<a href="/landing.php" target="_blank">/landing.php</a>) نمایش داده می‌شوند —
    همه‌ی ویدیوهای فعال به ترتیب «ترتیب نمایش» یکی‌یکی و به‌صورت خودکار جابه‌جا می‌شوند (دقیقاً مثل اسلایدر قدیمی، با فلش و نقطه‌های ناوبری).
    برای بارگذاری سریع صفحه، هر ویدیو را کوتاه، بدون صدا و حداکثر ۱۵ مگابایت آماده کنید (MP4 یا WEBM).
    ...
    همین تصویر جایگزین، وقتی بازدیدکننده موس را روی ویدیو نگه دارد هم به‌جای ویدیو نمایش داده می‌شود.
  </p>
