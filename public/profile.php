...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!backend_verify_password($cur, (string)$hash)) {
        ...
        flash('success', 'Password changed — this updates your account everywhere it is used.');
    }
...
<div class="grid grid-2">
  <div class="card">
    ...
    <p class="hint">This account is shared with the connected backend platform — the same login used everywhere else it's used.</p>
  </div>

  <div class="card">
    <h2>Change password</h2>
    <p class="hint">Changes your password everywhere, not just ELLSMS.</p>
    <form method="post">
      <?= csrf_field() ?>
